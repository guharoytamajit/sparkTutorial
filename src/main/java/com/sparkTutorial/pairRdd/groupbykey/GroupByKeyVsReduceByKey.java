...
public class GroupByKeyVsReduceByKey {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD<String, Integer> stringIntegerJavaPairRDD = wordsPairRdd.reduceByKey((x, y) -> x + y);
        List<Tuple2<String, Integer>> wordCountsWithReduceByKey = stringIntegerJavaPairRDD.collect();
